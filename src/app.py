...
activities = {
    ...
    "Art Studio": {
        "description": "Painting, drawing, and sculpture instruction for all levels",
        "schedule": "Tuesdays and Thursdays, 4:00 PM - 5:30 PM",
        "max_participants": 20,
        "participants": ["isabella@mergington.edu"]
    },
    "Music Ensemble": {
        "description": "Join our orchestra and chamber ensembles performing classical and contemporary music",
